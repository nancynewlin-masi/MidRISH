...
#python3.8 /nfs/masi/newlinnr/midrish/bvaluemap.py ${DWI} ${OUTDIR}/b0.nii.gz ${OUTDIR}/dwi_b1000.nii.gz
export DWI=${OUTDIR}/dwi_b1000.nii.gz
export BVAL=/nfs/masi/newlinnr/midrish/1000.bval
...
#echo "Report mean FA in region of interest (EVE WM region 44+45)"
#python3.8 extract_parcel_metrics.sh 
